                        ...
                        <div class="myRow">
                          <div class="myRecipe">  
                            ...
                            <div class="myRow">
                                ...
                                <a href="${pageContext.request.contextPath}/share?recipe_id=${recipe.id}&is_shared=${recipe.isShared}" class="btn btn-primary btn-warning" style="margin: 5px;">Wrzuć na główną</a>
