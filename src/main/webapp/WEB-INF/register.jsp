        ...
        <div class="myColumn" style="background-color: #f1f1f1;">
            <div class="myForm">
                <form action="register" method="post">
                        <h3 class="form-signin-heading">Zarejestruj się</h3>
                        <input name="inputEmail" type="email" class="form-control" style="margin-bottom: 5px;" placeholder="Email" required autofocus>
                        <input name="inputUsername" type="text" class="form-control" style="margin-bottom: 5px;" placeholder="Nazwa uzytkownika" required autofocus>
                        <input name="inputPassword" type="password" class="form-control" style="margin-bottom: 5px;" placeholder="Hasło" required>
                        <button class="btn btn-md btn-block" style="margin-bottom: 10px; background-color: #1abc9c; color:white" type="submit">Zarejestruj</button>
                </form>
            </div>    
        </div>
